...
def is_unicode_emoji(emoji: str) -> bool:
    """Return True if x is a unicode emoji else return False."""
    ...
    return bool(pattern.match(emoji))


class UnicodeEmojiConverter(EmojiConverter):  # pylint: disable=too-few-public-methods
    """
    UnicodeEmojiConverter. Extension of discord.ext.commands.EmojiConverter.

    Converts emojis into their unicode representation if they are unicode emojis.
    If not, uses default conversion from EmojiConverter.
    """
