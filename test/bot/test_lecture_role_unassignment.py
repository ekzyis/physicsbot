...
from src.event.on_raw_reaction_remove.lecture_role_unassignment import lecture_role_unassignment


class TestLectureRoleUnassignment(aiounittest.AsyncTestCase):
    ...
    async def test_on_raw_reaction_remove_removes_role_when_removed_white_check_mark_reaction_from_lecture_embed(self):
        ...
        await lecture_role_unassignment(self.bot)(reaction)
