...
from src.event.on_raw_reaction_add.lecture_role_assignment import lecture_role_assignment


class TestLectureRoleAssignment(aiounittest.AsyncTestCase):
    ...
    async def test_on_raw_reaction_add_adds_role_when_reacted_with_white_check_mark_on_lecture_embed(self):
        ...
        await lecture_role_assignment(self.bot)(reaction)
